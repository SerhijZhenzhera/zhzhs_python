...
class TVController:
    def __init__(self, ch, list_ch):
        self.position = 0
        self.choose_channel = ch
        self.list_channel = list_ch

    def first_channel(self):
        self.position = 0
        return self.list_channel[self.position]
    ...
    def is_exists(self, ch):
        if ch in range(len(self.choose_channel)) or ch in self.list_channel:
            return 'Yes'
        return 'No'
...
if __name__ == "__main__":
    ch1 = TVController(['1', '2', '3', '4', '5'], [
                       "BBC", "Discovery", "TV1000", "ICTV", "5 channel"])
